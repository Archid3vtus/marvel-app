...
//BA.debugLineNum = 13;BA.debugLine="charDetail.Height = 100%y - charDetail.Top - 10"[CharacterDetails/General script]
views.get("chardetail").vw.setHeight((int)((100d / 100 * height)-(views.get("chardetail").vw.getTop())-10d));
