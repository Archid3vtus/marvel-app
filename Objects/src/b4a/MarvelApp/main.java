...
RDebugUtils.currentLine=131076;
 //BA.debugLineNum = 131076;BA.debugLine="charList.SingleLineLayout.Label.TextColor = Color";
mostCurrent._charlist.getSingleLineLayout().Label.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
RDebugUtils.currentLine=131077;
 //BA.debugLineNum = 131077;BA.debugLine="character.Initialize(Me)";
...
anywheresoftware.b4a.objects.collections.List _characterlist = null;
anywheresoftware.b4a.objects.collections.Map _entry = null;
RDebugUtils.currentLine=720896;
 //BA.debugLineNum = 720896;BA.debugLine="Sub JobDone(Job As HttpJob) As HttpJob";
RDebugUtils.currentLine=720897;
 //BA.debugLineNum = 720897;BA.debugLine="If Job.Success = True Then";
if (_job._vvv7==anywheresoftware.b4a.keywords.Common.True) { 
RDebugUtils.currentLine=720898;
 //BA.debugLineNum = 720898;BA.debugLine="Select Job.JobName";
switch (BA.switchObjectToInt(_job._vvv6,"GetCharacter")) {
case 0: {
RDebugUtils.currentLine=720900;
 //BA.debugLineNum = 720900;BA.debugLine="json.Initialize(Job.GetString)";
mostCurrent._json.Initialize(_job._vv5());
RDebugUtils.currentLine=720901;
 //BA.debugLineNum = 720901;BA.debugLine="Dim data As Map = json.NextObject.Get(\"data\")";
_data = new anywheresoftware.b4a.objects.collections.Map();
_data.setObject((anywheresoftware.b4a.objects.collections.Map.MyMap)(mostCurrent._json.NextObject().Get((Object)("data"))));
RDebugUtils.currentLine=720902;
 //BA.debugLineNum = 720902;BA.debugLine="Dim characterList As List = data.Get(\"results\"";
_characterlist = new anywheresoftware.b4a.objects.collections.List();
_characterlist.setObject((java.util.List)(_data.Get((Object)("results"))));
RDebugUtils.currentLine=720903;
 //BA.debugLineNum = 720903;BA.debugLine="For Each entry As Map In characterList";
_entry = new anywheresoftware.b4a.objects.collections.Map();
{
final anywheresoftware.b4a.BA.IterableList group7 = _characterlist;
...
RDebugUtils.currentLine=720904;
 //BA.debugLineNum = 720904;BA.debugLine="charList.AddSingleLine(entry.Get(\"name\"))";
...
RDebugUtils.currentLine=720910;
 //BA.debugLineNum = 720910;BA.debugLine="Job.Release";
_job._vvv5();
...
RDebugUtils.currentLine=786432;
 //BA.debugLineNum = 786432;BA.debugLine="Sub send_Click";
RDebugUtils.currentLine=786433;
 //BA.debugLineNum = 786433;BA.debugLine="charList.Clear";
mostCurrent._charlist.Clear();
RDebugUtils.currentLine=786434;
 //BA.debugLineNum = 786434;BA.debugLine="character.GetCharacter(searchBar.Text, \"99\")";
